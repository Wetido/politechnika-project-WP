...
.news-header{
  ...
  DzialnoscPage.getInitialProps = async (params) => {
    const response = await axios.get( `http://localhost:8000/wp-json/wp/v2/dzialalnosc?slug=${ params.query.slug }` )
